...
public class AesCryptoTransformTests
{
    ...
    [Fact]
    public void DeriveKey1And2ShouldAgree()
    {
        var key1 = AesCryptoTransform.DeriveKey(TestPassword, Encoding.UTF8.GetBytes(TestSalt));
        key1.Should().BeEquivalentTo([0x08, 0x9A, 0x69, 0x5B, 0xEC, 0x0C, 0x50, 0x61, 0xBA, 0xDC, 0x3C, 0xA2, 0x68, 0xFB, 0x95, 0xDE, 0x30, 0x24, 0x4B, 0x50, 0x5F, 0xCC, 0xAB, 0xC7, 0x6F, 0xCB, 0xD4, 0x17, 0xB2, 0x63, 0xD7, 0x2C]);
    }
