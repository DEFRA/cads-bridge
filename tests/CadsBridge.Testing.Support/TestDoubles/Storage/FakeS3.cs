...
public class FakeS3 : IAmazonS3
{
    ...
    public readonly List<PutObjectRequest> PutRequests = [];
    public readonly Dictionary<string, string> UploadedContent = [];

    public Task<GetObjectResponse> GetObjectAsync(string bucket, string key, CancellationToken token)
        => Task.FromResult(new GetObjectResponse
        {
            ResponseStream = new MemoryStream(Encoding.UTF8.GetBytes(EncryptedContent ?? ""))
        });

    public Task<GetObjectResponse> GetObjectAsync(GetObjectRequest request, CancellationToken token)
        => Task.FromResult(new GetObjectResponse
        {
            ResponseStream = new MemoryStream(Encoding.UTF8.GetBytes(EncryptedContent ?? ""))
        });

    public Task<GetObjectMetadataResponse> GetObjectMetadataAsync(string bucket, string key, CancellationToken token)
    ...
    public Task<PutObjectResponse> PutObjectAsync(PutObjectRequest request, CancellationToken token)
    {
        ...
        {
            using var reader = new StreamReader(request.InputStream, Encoding.UTF8, leaveOpen: true);
            UploadedContent[request.Key] = reader.ReadToEnd();
        }
    ...
    public Task<CreatePresignedPostResponse> CreatePresignedPostAsync(CreatePresignedPostRequest request)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<CopyPartResponse> CopyPartAsync(string sourceBucket, string sourceKey, string destinationBucket, string destinationKey, string uploadId, int? partNumber, CancellationToken cancellationToken = default)
    {
        throw new NotImplementedException();
    }

    public Task<CopyPartResponse> CopyPartAsync(string sourceBucket, string sourceKey, string sourceVersionId, string destinationBucket, string destinationKey, string uploadId, int? partNumber, CancellationToken cancellationToken = default)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<CreateBucketMetadataConfigurationResponse> CreateBucketMetadataConfigurationAsync(CreateBucketMetadataConfigurationRequest request, CancellationToken cancellationToken = default)
    {
        throw new NotImplementedException();
    }

    public Task<CreateBucketMetadataTableConfigurationResponse> CreateBucketMetadataTableConfigurationAsync(CreateBucketMetadataTableConfigurationRequest request, CancellationToken cancellationToken = default)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<DeleteBucketMetadataConfigurationResponse> DeleteBucketMetadataConfigurationAsync(DeleteBucketMetadataConfigurationRequest request, CancellationToken cancellationToken = default)
    {
        throw new NotImplementedException();
    }

    public Task<DeleteBucketMetadataTableConfigurationResponse> DeleteBucketMetadataTableConfigurationAsync(DeleteBucketMetadataTableConfigurationRequest request, CancellationToken cancellationToken = default)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<GetBucketAbacResponse> GetBucketAbacAsync(GetBucketAbacRequest request, CancellationToken cancellationToken = default)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<GetBucketMetadataConfigurationResponse> GetBucketMetadataConfigurationAsync(GetBucketMetadataConfigurationRequest request, CancellationToken cancellationToken = default)
    {
        throw new NotImplementedException();
    }

    public Task<GetBucketMetadataTableConfigurationResponse> GetBucketMetadataTableConfigurationAsync(GetBucketMetadataTableConfigurationRequest request, CancellationToken cancellationToken = default)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<GetObjectAclResponse> GetObjectAclAsync(GetObjectAclRequest request, CancellationToken cancellationToken = default)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<PutBucketAbacResponse> PutBucketAbacAsync(PutBucketAbacRequest request, CancellationToken cancellationToken = default)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<PutObjectAclResponse> PutObjectAclAsync(PutObjectAclRequest request, CancellationToken cancellationToken = default)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<RenameObjectResponse> RenameObjectAsync(RenameObjectRequest request, CancellationToken cancellationToken = default)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<UpdateBucketMetadataInventoryTableConfigurationResponse> UpdateBucketMetadataInventoryTableConfigurationAsync(UpdateBucketMetadataInventoryTableConfigurationRequest request, CancellationToken cancellationToken = default)
    {
        throw new NotImplementedException();
    }

    public Task<UpdateBucketMetadataJournalTableConfigurationResponse> UpdateBucketMetadataJournalTableConfigurationAsync(UpdateBucketMetadataJournalTableConfigurationRequest request, CancellationToken cancellationToken = default)
    {
        throw new NotImplementedException();
    }

    public Task<UpdateObjectEncryptionResponse> UpdateObjectEncryptionAsync(UpdateObjectEncryptionRequest request, CancellationToken cancellationToken = default)
    {
        throw new NotImplementedException();
    }
